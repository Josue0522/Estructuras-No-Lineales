...
public class AVLTree {
    ...
    private Node rightRotate(Node nodeR) {
        ...
        System.out.println("Nueva raiz despues de la rotacion derecha: "+x.getValue());
    ...
    private Node leftRotate(Node nodeL) {
        System.out.println("Rotacion izquierda en "+nodeL.getValue()+", Balance: "+getBalance(nodeL));
        Node y = nodeL.getRight();
        System.out.println("Nueva raiz despues de la rotacion hacia la izquierda "+y.getValue()+", Balance:"+getBalance(nodeL));
        Node temp = y.getLeft();
